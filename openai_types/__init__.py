...
#   filename:  <stdin>
#   timestamp: 2024-10-13T21:35:59+00:00
...
class CreateChatCompletionStreamResponse(BaseModel):
    ...
    """
    service_tier: Optional[ServiceTier1] = Field(default=None, examples=['scale'])
    """
    The service tier used for processing the request. This field is only included if the `service_tier` parameter is specified in the request.
    """
...
class CreateImageRequest(BaseModel):
    ...
    model: Optional[Union[str, Model3]] = Field(
        default='dall-e-2', examples=['dall-e-3']
    )
    """
    The model to use for image generation.
    """
    n: Optional[int] = Field(default=1, examples=[1], ge=1, le=10)
    """
    The number of images to generate. Must be between 1 and 10. For `dall-e-3`, only `n=1` is supported.
    """
    quality: Optional[Quality] = Field(default='standard', examples=['standard'])
    """
    The quality of the image that will be generated. `hd` creates images with finer details and greater consistency across the image. This param is only supported for `dall-e-3`.
    """
    response_format: Optional[ResponseFormat] = Field(default='url', examples=['url'])
    """
    The format in which the generated images are returned. Must be one of `url` or `b64_json`. URLs are only valid for 60 minutes after the image has been generated.
    """
    size: Optional[Size] = Field(default='1024x1024', examples=['1024x1024'])
    """
    The size of the generated images. Must be one of `256x256`, `512x512`, or `1024x1024` for `dall-e-2`. Must be one of `1024x1024`, `1792x1024`, or `1024x1792` for `dall-e-3` models.
    """
    style: Optional[Style] = Field(default='vivid', examples=['vivid'])
    """
    The style of the generated images. Must be one of `vivid` or `natural`. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images. This param is only supported for `dall-e-3`.
    """
    user: Optional[str] = Field(default=None, examples=['user-1234'])
    """
...
class CreateImageEditRequest(BaseModel):
    ...
    model: Optional[Union[str, Model4]] = Field(
        default='dall-e-2', examples=['dall-e-2']
    )
    """
    The model to use for image generation. Only `dall-e-2` is supported at this time.
    """
    ...
    """
    size: Optional[Size1] = Field(default='1024x1024', examples=['1024x1024'])
    """
    The size of the generated images. Must be one of `256x256`, `512x512`, or `1024x1024`.
    """
    response_format: Optional[ResponseFormat] = Field(default='url', examples=['url'])
...
class CreateModerationRequest(BaseModel):
    input: Union[str, List[str], List[Union[Input, Input1]]]
    """
    ...
    model: Optional[Union[str, Model6]] = Field(
        default='omni-moderation-latest', examples=['omni-moderation-2024-09-26']
    )
    """
    The content moderation model you would like to use. Learn more in
    [the moderation guide](/docs/guides/moderation), and learn about
...
class Hyperparameters(BaseModel):
    ...
    batch_size: Optional[Union[BatchSize, BatchSize1]] = 'auto'
    """
    Number of examples in each batch. A larger batch size means that model parameters
    are updated less frequently, but with lower variance.
    ...
    learning_rate_multiplier: Optional[
        Union[LearningRateMultiplier, LearningRateMultiplier1]
    ] = 'auto'
    """
    Scaling factor for the learning rate. A smaller learning rate may be useful to avoid
    overfitting.
    ...
    """
    n_epochs: Optional[Union[NEpochs, NEpochs1]] = 'auto'
    """
    The number of epochs to train the model for. An epoch refers to one full cycle
    through the training dataset.
...
class CreateFineTuningJobRequest(BaseModel):
    model: Union[str, Model7] = Field(..., examples=['gpt-4o-mini'])
    """
    The name of the model to fine-tune. You can select one of the
    [supported models](/docs/guides/fine-tuning/which-models-can-be-fine-tuned).
    ...
    The hyperparameters used for the fine-tuning job.
    """
    suffix: Optional[str] = Field(default=None, max_length=64, min_length=1)
    """
    ...
    """
    validation_file: Optional[str] = Field(default=None, examples=['file-abc123'])
    """
    ...
    """
    seed: Optional[int] = Field(default=None, examples=[42], ge=0, le=2147483647)
    """
...
class Input2(RootModel[List[str]]):
    root: List[str] = Field(
        ...,
...
class Input3(RootModel[List[int]]):
    root: List[int] = Field(
        ...,
...
class Input4Item(Prompt1Item):
    pass


class Input4(RootModel[List[Input4Item]]):
    root: List[Input4Item] = Field(
        ...,
        examples=['[[1212, 318, 257, 1332, 13]]'],
        max_length=2048,
        min_length=1,
...
class CreateEmbeddingRequest(BaseModel):
    ...
    input: Union[str, Input2, Input3, Input4] = Field(
        ..., examples=['The quick brown fox jumped over the lazy dog']
    )
    """
    ...
    """
    model: Union[str, Model8] = Field(..., examples=['text-embedding-3-small'])
    """
    ID of the model to use. You can use the [List models](/docs/api-reference/models/list) API to see all of your available models, or see our [Model overview](/docs/models/overview) for descriptions of them.

    """
    encoding_format: Optional[EncodingFormat] = Field(
        default='float', examples=['float']
    )
    """
    The format to return the embeddings in. Can be either `float` or [`base64`](https://pypi.org/project/pybase64/).
    """
...
class CreateTranslationRequest(BaseModel):
    ...
    """
    model: Union[str, Model9] = Field(..., examples=['whisper-1'])
    """
    ID of the model to use. Only `whisper-1` (which is powered by our open source Whisper V2 model) is currently available.
...
class CreateSpeechRequest(BaseModel):
    ...
    The voice to use when generating the audio. Supported voices are `alloy`, `echo`, `fable`, `onyx`, `nova`, and `shimmer`. Previews of the voices are available in the [Text to speech guide](/docs/guides/text-to-speech/voice-options).
    """
    response_format: Optional[ResponseFormat3] = 'mp3'
    """
    The format to audio in. Supported formats are `mp3`, `opus`, `aac`, `flac`, `wav`, and `pcm`.
    """
...
class CodeInterpreter(BaseModel):
    file_ids: Optional[List[str]] = Field(default=[], max_length=20)
    """
...
class FileSearch(BaseModel):
    vector_store_ids: Optional[List[str]] = Field(default=None, max_length=1)
    """
...
class VectorStore(BaseModel):
    file_ids: Optional[List[str]] = Field(default=None, max_length=10000)
    """
...
class FileSearch1(BaseModel):
    ...
    """
    vector_stores: Optional[List[VectorStore]] = Field(default=None, max_length=1)
    """
...
class TruncationObject(BaseModel):
    ...
    The truncation strategy to use for the thread. The default is `auto`. If set to `last_messages`, the thread will be truncated to the n most recent messages in the thread. When set to `auto`, messages in the middle of the thread will be dropped to fit the context length of the model, `max_prompt_tokens`.
    """
    last_messages: Optional[int] = Field(default=None, ge=1)
    """
...
class FileSearch7(BaseModel):
    ...
    """
    vector_stores: Optional[List[VectorStore2]] = Field(default=None, max_length=1)
    """
...
class RunStepDeltaStepDetailsToolCallsFunctionObject(BaseModel):
    ...
    The type of tool call. This is always going to be `function` for this type of tool call.
    """
    function: Optional[Function6] = None
    """
    The definition of the function that was called.
    """
...
class ListBatchesResponse(BaseModel):
    data: List[Batch]
    first_id: Optional[str] = Field(default=None, examples=['batch_abc123'])
    last_id: Optional[str] = Field(default=None, examples=['batch_abc456'])
    has_more: bool
    object: Object
...
class AuditLog(BaseModel):
    ...
    api_key_created: Optional[ApiKeyCreated] = Field(
        default=None, alias='api_key.created'
    )
    """
    The details for events with this `type`.
    """
    api_key_updated: Optional[ApiKeyUpdated] = Field(
        default=None, alias='api_key.updated'
    )
    """
    The details for events with this `type`.
    """
    api_key_deleted: Optional[ApiKeyDeleted] = Field(
        default=None, alias='api_key.deleted'
    )
    """
    The details for events with this `type`.
    """
    invite_sent: Optional[InviteSent] = Field(default=None, alias='invite.sent')
    """
    The details for events with this `type`.
    """
    invite_accepted: Optional[InviteAccepted] = Field(
        default=None, alias='invite.accepted'
    )
    """
    The details for events with this `type`.
    """
    invite_deleted: Optional[InviteDeleted] = Field(
        default=None, alias='invite.deleted'
    )
    """
    The details for events with this `type`.
    """
    login_failed: Optional[LoginFailed] = Field(default=None, alias='login.failed')
    """
    The details for events with this `type`.
    """
    logout_failed: Optional[LogoutFailed] = Field(default=None, alias='logout.failed')
    """
    The details for events with this `type`.
    """
    organization_updated: Optional[OrganizationUpdated] = Field(
        default=None, alias='organization.updated'
    )
    """
    The details for events with this `type`.
    """
    project_created: Optional[ProjectCreated] = Field(
        default=None, alias='project.created'
    )
    """
    The details for events with this `type`.
    """
    project_updated: Optional[ProjectUpdated] = Field(
        default=None, alias='project.updated'
    )
    """
    The details for events with this `type`.
    """
    project_archived: Optional[ProjectArchived] = Field(
        default=None, alias='project.archived'
    )
    """
    The details for events with this `type`.
    """
    ...
    The details for events with this `type`.
    """
    user_added: Optional[UserAdded] = Field(default=None, alias='user.added')
    """
    The details for events with this `type`.
    """
    user_updated: Optional[UserUpdated] = Field(default=None, alias='user.updated')
    """
    The details for events with this `type`.
    """
    user_deleted: Optional[UserDeleted] = Field(default=None, alias='user.deleted')
    """
    The details for events with this `type`.
    """
...
class FineTuningJobsFineTuningJobIdEventsGetParametersQuery(
    FineTuningJobsGetParametersQuery
):
    pass
...
class ThreadsThreadIdRunsGetParametersQuery(AssistantsGetParametersQuery):
    pass
...
class ThreadsThreadIdRunsPostParametersQuery(BaseModel):
    include__: Optional[List[IncludeEnum]] = Field(default=None, alias='include[]')
...
class ThreadsThreadIdRunsRunIdStepsStepIdGetParametersQuery(
    ThreadsThreadIdRunsPostParametersQuery
):
    pass


class VectorStoresGetParametersQuery(AssistantsGetParametersQuery):
    pass
...
class VectorStoresVectorStoreIdFileBatchesBatchIdFilesGetParametersQuery(
    VectorStoresVectorStoreIdFilesGetParametersQuery
):
    pass
...
class BatchesGetParametersQuery(FineTuningJobsGetParametersQuery):
    pass
...
class OrganizationAuditLogsGetParametersQuery(BaseModel):
    effective_at: Optional[EffectiveAt] = None
    project_ids__: Optional[List[str]] = Field(default=None, alias='project_ids[]')
    event_types__: Optional[List[AuditLogEventType]] = Field(
        default=None, alias='event_types[]'
    )
    actor_ids__: Optional[List[str]] = Field(default=None, alias='actor_ids[]')
    actor_emails__: Optional[List[str]] = Field(default=None, alias='actor_emails[]')
    resource_ids__: Optional[List[str]] = Field(default=None, alias='resource_ids[]')
    limit: Optional[int] = 20
    after: Optional[str] = None
    before: Optional[str] = None


class OrganizationInvitesGetParametersQuery(BaseModel):
    limit: Optional[int] = 20
    after: Optional[str] = None


class OrganizationUsersGetParametersQuery(OrganizationInvitesGetParametersQuery):
    pass


class OrganizationProjectsGetParametersQuery(BaseModel):
    limit: Optional[int] = 20
    after: Optional[str] = None
    include_archived: Optional[bool] = False


class OrganizationProjectsProjectIdUsersGetParametersQuery(
    OrganizationInvitesGetParametersQuery
):
    pass


class OrganizationProjectsProjectIdServiceAccountsGetParametersQuery(
    OrganizationInvitesGetParametersQuery
):
    pass


class OrganizationProjectsProjectIdApiKeysGetParametersQuery(
    OrganizationInvitesGetParametersQuery
):
    pass
...
class CreateCompletionRequest(BaseModel):
    ...
    """
    prompt: Union[str, List[str], Prompt, Prompt1]
    """
    The prompt(s) to generate completions for, encoded as a string, array of strings, array of tokens, or array of token arrays.
    ...
    **Note:** Because this parameter generates many completions, it can quickly consume your token quota. Use carefully and ensure that you have reasonable settings for `max_tokens` and `stop`.
    ...
    """
    max_tokens: Optional[int] = Field(default=16, examples=[16], ge=0)
    """
    ...
    """
    n: Optional[int] = Field(default=1, examples=[1], ge=1, le=128)
    """
    ...
    **Note:** Because this parameter generates many completions, it can quickly consume your token quota. Use carefully and ensure that you have reasonable settings for `max_tokens` and `stop`.
    ...
    suffix: Optional[str] = Field(default=None, examples=['test.'])
    """
    ...
    """
    temperature: Optional[float] = Field(default=1, examples=[1], ge=0.0, le=2.0)
    """
    ...
    """
    top_p: Optional[float] = Field(default=1, examples=[1], ge=0.0, le=1.0)
    """
...
class RunStepDeltaStepDetailsToolCallsCodeObject(BaseModel):
    ...
    The type of tool call. This is always going to be `code_interpreter` for this type of tool call.
    """
    code_interpreter: Optional[CodeInterpreter8] = None
    """
    The Code Interpreter tool call definition.
    """
...
class CreateVectorStoreRequest(BaseModel):
    ...
    file_ids: Optional[List[str]] = Field(default=None, max_length=500)
    """
    A list of [File](/docs/api-reference/files) IDs that the vector store should use. Useful for tools like `file_search` that can access files.
    """
    name: Optional[str] = None
...
class ChatCompletionRequestAssistantMessage(BaseModel):
    content: Optional[Union[str, Content2]] = None
    """
...
class FinetuneChatRequestInput(BaseModel):
    ...
    functions: Optional[List[ChatCompletionFunctions]] = Field(
        default=None, max_length=128, min_length=1
    )
    """
...
class CreateAssistantRequest(BaseModel):
    ...
    model: Union[str, Model12] = Field(..., examples=['gpt-4o'])
    """
    ID of the model to use. You can use the [List models](/docs/api-reference/models/list) API to see all of your available models, or see our [Model overview](/docs/models/overview) for descriptions of them.
    ...
    """
    instructions: Optional[str] = Field(default=None, max_length=256000)
    """
    The system instructions that the assistant uses. The maximum length is 256,000 characters.
...
class CreateRunRequest(BaseModel):
    ...
    """
    model: Optional[Union[str, Model13]] = Field(default=None, examples=['gpt-4o'])
    """
    The ID of the [Model](/docs/api-reference/models) to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used.
    """
...
class CreateChatCompletionRequest(BaseModel):
    ...
    """
    model: Union[str, Model2] = Field(..., examples=['gpt-4o'])
    """
    ID of the model to use. See the [model endpoint compatibility](/docs/models/model-endpoint-compatibility) table for details on which models work with the Chat API.
    """
    frequency_penalty: Optional[float] = Field(default=0, ge=-2.0, le=2.0)
    ...
    **Important:** when using JSON mode, you **must** also instruct the model to produce JSON yourself via a system or user message. Without this, the model may generate an unending stream of whitespace until the generation reaches the token limit, resulting in a long-running and seemingly "stuck" request. Also note that the message content may be partially cut off if `finish_reason="length"`, which indicates the generation exceeded `max_tokens` or the conversation exceeded the max context length.
    ...
    """
    stop: Optional[Union[str, Stop1]] = None
    """
    Up to 4 sequences where the API will stop generating further tokens.
