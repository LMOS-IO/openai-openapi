...
#   filename:  <stdin>
#   timestamp: 2024-10-20T15:59:37+00:00
...
class CodeInterpreter(BaseModel):
    file_ids: List[str] = Field(default=[], max_length=20)
    """
...
class CreateCompletionRequest(BaseModel):
    ...
    """
    prompt: Optional[Union[Optional[str], List[str], Prompt, Prompt1]] = Field(...)
    """
    The prompt(s) to generate completions for, encoded as a string, array of strings, array of tokens, or array of token arrays.
    ...
    **Note:** Because this parameter generates many completions, it can quickly consume your token quota. Use carefully and ensure that you have reasonable settings for `max_tokens` and `stop`.
    ...
    seed: Optional[int] = Field(
        default=None, ge=-9223372036854776000, le=9223372036854776000
    )
    """
...
class CreateEmbeddingRequest(BaseModel):
    ...
    """
    encoding_format: EncodingFormat = Field(default='float', examples=['float'])
    """
    The format to return the embeddings in. Can be either `float` or [`base64`](https://pypi.org/project/pybase64/).
    """
...
class CreateImageRequest(BaseModel):
    ...
    """
    quality: Quality = Field(default='standard', examples=['standard'])
    """
    The quality of the image that will be generated. `hd` creates images with finer details and greater consistency across the image. This param is only supported for `dall-e-3`.
    """
    response_format: Optional[ResponseFormat] = Field(default='url', examples=['url'])
...
class CreateSpeechRequest(BaseModel):
    ...
    The format to audio in. Supported formats are `mp3`, `opus`, `aac`, `flac`, `wav`, and `pcm`.
    """
    speed: float = Field(default=1, ge=0.25, le=4.0)
    """
...
class VectorStoreFileObject(BaseModel):
    ...
    The status of the vector store file, which can be either `in_progress`, `completed`, `cancelled`, or `failed`. The status `completed` indicates that the vector store file is ready for use.
    """
    last_error: Optional[LastError2] = Field(...)
    """
    The last error associated with this vector store file. Will be `null` if there are no errors.
    """
...
class FineTuningJobsGetParametersQuery(BatchesGetParametersQuery):
    pass
...
class FineTuningJobsFineTuningJobIdEventsGetParametersQuery(BatchesGetParametersQuery):
    pass
...
class VectorStoresVectorStoreIdFilesGetParametersQuery(
    VectorStoresVectorStoreIdFileBatchesBatchIdFilesGetParametersQuery
):
    pass
...
class CreateRunRequest(BaseModel):
    ...
    """
    model: Optional[Union[Optional[str], Model9]] = Field(
        default=None, examples=['gpt-4o']
    )
    """
    The ID of the [Model](/docs/api-reference/models) to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used.
    """
...
class RunObject(BaseModel):
    ...
    """
    max_prompt_tokens: Optional[int] = Field(..., ge=256)
    """
    The maximum number of prompt tokens specified to have been used over the course of the run.

    """
    max_completion_tokens: Optional[int] = Field(..., ge=256)
    """
    The maximum number of completion tokens specified to have been used over the course of the run.

    """
    truncation_strategy: Optional[TruncationObject] = Field(...)
    tool_choice: Optional[AssistantsApiToolChoiceOption] = Field(...)
    parallel_tool_calls: ParallelToolCalls
    response_format: Optional[AssistantsApiResponseFormatOption] = Field(...)
...
class AssistantObject(BaseModel):
    ...
    """
    instructions: Optional[str] = Field(..., max_length=256000)
    """
    The system instructions that the assistant uses. The maximum length is 256,000 characters.
