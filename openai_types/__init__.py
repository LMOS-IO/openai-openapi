...
#   filename:  <stdin>
#   timestamp: 2024-10-20T20:26:31+00:00
...
class Static(BaseModel):
    ...
    max_chunk_size_tokens: conint(ge=100, le=4096)
    """
...
class CreateCompletionRequest(BaseModel):
    ...
    """
    prompt: Optional[Union[Optional[str], List[str], List[int], List[PromptItem]]] = (
        Field(...)
    )
    """
...
class CreateEmbeddingRequest(BaseModel):
    ...
    The format to return the embeddings in. Can be either `float` or [`base64`](https://pypi.org/project/pybase64/).
    """
    dimensions: Optional[conint(ge=1)] = None
    """
...
class Hyperparameters(BaseModel):
    ...
    batch_size: Union[BatchSize, conint(ge=1, le=256)] = 'auto'
    """
    Number of examples in each batch. A larger batch size means that model parameters
    are updated less frequently, but with lower variance.

    """
    learning_rate_multiplier: Union[LearningRateMultiplier, PositiveFloat] = 'auto'
    """
    Scaling factor for the learning rate. A smaller learning rate may be useful to avoid
    overfitting.

    """
    n_epochs: Union[NEpochs, conint(ge=1, le=50)] = 'auto'
    """
    The number of epochs to train the model for. An epoch refers to one full cycle
    through the training dataset.
...
class CreateFineTuningJobRequest(BaseModel):
    ...
    The hyperparameters used for the fine-tuning job.
    """
    suffix: Optional[constr(min_length=1, max_length=64)] = None
    """
    ...
    """
    seed: Optional[conint(ge=0, le=2147483647)] = Field(None, examples=[42])
    """
...
class CreateSpeechRequest(BaseModel):
    ...
    The format to audio in. Supported formats are `mp3`, `opus`, `aac`, `flac`, `wav`, and `pcm`.
    """
    speed: confloat(ge=0.25, le=4.0) = 1
    """
...
class FileSearchRankingOptions(BaseModel):
    ...
    The ranker to use for the file search. If not specified will use the `auto` ranker.
    """
    score_threshold: confloat(ge=0.0, le=1.0)
    """
...
class Hyperparameters1(BaseModel):
    ...
    n_epochs: Union[NEpochs1, conint(ge=1, le=50)]
    """
    The number of epochs to train the model for. An epoch refers to one full cycle through the training dataset.
    "auto" decides the optimal number of epochs based on the size of the dataset. If setting the number manually, we support any number between 1 and 50 epochs.
    """
...
class TruncationObject(BaseModel):
    ...
    The truncation strategy to use for the thread. The default is `auto`. If set to `last_messages`, the thread will be truncated to the n most recent messages in the thread. When set to `auto`, messages in the middle of the thread will be dropped to fit the context length of the model, `max_prompt_tokens`.
    """
    last_messages: Optional[conint(ge=1)] = None
    """
...
class FileSearch1(BaseModel):
    ...
    max_num_results: Optional[conint(ge=1, le=50)] = None
    """
...
class ChatCompletionRequestAssistantMessage(BaseModel):
    content: Optional[
        Union[Optional[str], List[ChatCompletionRequestAssistantMessageContentPart]]
    ] = None
    """
...
class CreateAssistantRequest(BaseModel):
    ...
    """
    instructions: Optional[constr(max_length=256000)] = None
    """
...
class CreateRunRequest(BaseModel):
    ...
    """
    max_prompt_tokens: Optional[conint(ge=256)] = None
    """
    The maximum number of prompt tokens that may be used over the course of the run. The run will make a best effort to use only the number of prompt tokens specified, across multiple turns of the run. If the run exceeds the number of prompt tokens specified, the run will end with status `incomplete`. See `incomplete_details` for more info.

    """
    max_completion_tokens: Optional[conint(ge=256)] = None
    """
...
class RunObject(BaseModel):
    ...
    """
    max_prompt_tokens: Optional[conint(ge=256)] = Field(None)
    """
    The maximum number of prompt tokens specified to have been used over the course of the run.

    """
    max_completion_tokens: Optional[conint(ge=256)] = Field(None)
    """
...
class AssistantObject(BaseModel):
    ...
    """
    name: Optional[constr(max_length=256)] = Field(None)
    """
    The name of the assistant. The maximum length is 256 characters.

    """
    description: Optional[constr(max_length=512)] = Field(None)
    """
    The description of the assistant. The maximum length is 512 characters.
    ...
    """
    instructions: Optional[constr(max_length=256000)] = Field(None)
    """
    The system instructions that the assistant uses. The maximum length is 256,000 characters.
